...
Widget authenticationDesignImages(BuildContext context) {
  final compact = MediaQuery.sizeOf(context).height >=
      MediaQuery.sizeOf(context).width;
  return SizedBox(
      width: MediaQuery.sizeOf(context).width * (compact ? 0.9 : 0.5),
      height: MediaQuery.sizeOf(context).height * (compact ? 0.32 : 0.78),
      child: Column(
        children: [

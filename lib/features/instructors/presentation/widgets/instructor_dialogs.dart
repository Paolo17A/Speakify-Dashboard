...
void displayInstructorDialogue(BuildContext context,
    Map<String, dynamic> instructorData, Function deleteInstructor) async {
  String profileImageURL = instructorData['profileImageURL'] ?? '';
  String instructorName =
      '${instructorData['firstName']} ${instructorData['lastName']}';
  List<dynamic> handledSections =
      List<dynamic>.from(instructorData['handledSections'] ?? []);
  showDialog(
      context: context,
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        child: all20Pix(const Text('Delete Instructor'))),
                    const Gap(50),
                    ElevatedButton(
              ...
              child: all20Pix(Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: all20Pix(const Text('ADD NEW INSTRUCTOR'))),
                  const Gap(50),
                  ElevatedButton(
                      onPressed: () => Navigator.of(context).pop(),
                      child: const Text('\tCLOSE\t')),
              ...
              child: all20Pix(Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: all20Pix(const Text('EDIT INSTRUCTOR'))),
                  const Gap(50),
                  ElevatedButton(
                      onPressed: () => Navigator.of(context).pop(),
                      child: const Text('\tCLOSE\t')),

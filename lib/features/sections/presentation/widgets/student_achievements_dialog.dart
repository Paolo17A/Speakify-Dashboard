...
import 'package:speechlab_dashboard/features/sections/data/models/achievement_model.dart';
...
void displayStudentAchievementsDialogue(
  ...
  for (int i = 0; i < achievements.length; i++) {
    final achievement = getAchievement(achievements[i]);
    if (achievement != null) {
      earnedAchievements[achievements[i]] = achievement;
    }
  }
  showDialog(
    context: context,
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          color: const Color.fromARGB(255, 165, 115, 153),
